...
class PetFinderAPIClient {
    ...
    class func loadAnimals(completion:@escaping ([JSON]) -> ()) {
        Alamofire.request("http://api.petfinder.com/pet.find?format=json&key=bdd45c8f6e757c91dd529fa76516c1e6&animal=dog&location=94089&age=senior").responseJSON { (response) in
